...
class Configuration implements ConfigurationInterface
{
    ...
    public function configureRestler(Restler $restler)
    {
        ...
        $restler->addAPIClass('Aoe\\RestlerExamples\\Controller\\TestController', 'api/testy');
        ...
        $restler->addAPIClass('Aoe\\RestlerExamples\\Controller\\RestApiClientExamples\\NochnTestController', 'api/rest-api-client');
